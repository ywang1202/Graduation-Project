  ...
  def discriminator(self, img, reuse, update_collection=None):
    with tf.compat.v1.variable_scope('discriminator', reuse=reuse):
        ...
        with tf.compat.v1.variable_scope('layer_1'):
            weights = tf.compat.v1.get_variable("w_1", [3, 3, 1, 32], initializer=tf.truncated_normal_initializer(stddev=1e-3))
            weights = weights_spectral_norm(weights, update_collection=update_collection)
            bias = tf.compat.v1.get_variable("b_1", [32], initializer=tf.constant_initializer(0.0))
        ...
        with tf.compat.v1.variable_scope('layer_2'):
            weights = tf.compat.v1.get_variable("w_2", [3, 3, 32, 64], initializer=tf.truncated_normal_initializer(stddev=1e-3))
            weights = weights_spectral_norm(weights, update_collection=update_collection)
            bias = tf.compat.v1.get_variable("b_2", [64], initializer=tf.constant_initializer(0.0))
        ...
        with tf.compat.v1.variable_scope('layer_3'):
            weights = tf.compat.v1.get_variable("w_3", [3, 3, 64, 128], initializer=tf.truncated_normal_initializer(stddev=1e-3))
            weights = weights_spectral_norm(weights, update_collection=update_collection)
            bias = tf.compat.v1.get_variable("b_3", [128], initializer=tf.constant_initializer(0.0))
        ...
        with tf.compat.v1.variable_scope('layer_4'):
            weights = tf.compat.v1.get_variable("w_4", [3, 3, 128, 256], initializer=tf.truncated_normal_initializer(stddev=1e-3))
            weights = weights_spectral_norm(weights, update_collection=update_collection)
            bias = tf.compat.v1.get_variable("b_4", [256], initializer=tf.constant_initializer(0.0))
        ...
        with tf.compat.v1.variable_scope('line_5'):
            weights = tf.compat.v1.get_variable("w_5", [6 * 6 * 256, 1], initializer=tf.truncated_normal_initializer(stddev=1e-3))
            weights = weights_spectral_norm(weights, update_collection=update_collection)
            bias = tf.compat.v1.get_variable("b_5", [1], initializer=tf.constant_initializer(0.0))
